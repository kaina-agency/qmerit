		...
		<div className={styles.container}>
			...
			<nav className="bg-black h-12 w-full flex justify-center">
				<div className="max-w-screen-xl w-full flex justify-center space-x-12 items-center relative">
					...
					<a
						className="appearance-none text-grey-light text-sm tracking-wide uppercase stat-text-link"
						data-dtm="global nav"
						href={
							isEnglish
								? 'https://www.chevrolet.ca/en/upcoming-vehicles/2022-bolt-euv'
								: 'https://www.chevrolet.ca/fr/upcoming-vehicles/2022-bolt-euv'
						}
						target="_blank"
						rel="noreferrer"
					>
					...
					<a
						...
						href={
							isEnglish
								? 'https://www.chevrolet.ca/en/upcoming-vehicles/2022-bolt-ev'
								: 'https://www.chevrolet.ca/fr/upcoming-vehicles/2022-bolt-ev'
						}
						target="_blank"
						rel="noreferrer"
					>
					...
					<button
						className="absolute right-5 top-1/2 transform -translate-y-1/2 text-grey-light text-sm focus:outline-none outline-none stat-text-link"
						data-dtm="global nav"
					...
					>
						<span
							className={
								isEnglish
									? 'text-grey-light'
									: 'text-grey-mid' + ' text-sm uppercase'
							}
						>
							EN
						</span>
			...
			<header
				className={
					styles.header + ' w-full relative flex justify-center align-center'
				}
			>
				<img
			...
			>
				<div className="container max-w-screen-md mx-auto py-4 pr-6 flex justify-end">
					<button
						onClick={reset}
						className="bg-white hover:text-error text-blue text-xs text-bold uppercase px-6 py-1 br-8 rounded-full stat-button-link"
						data-dtm="global nav"
					>
						{isEnglish ? 'Clear All Fields' : 'Effacer Tous les Champs'}
					</button>
				</div>
			</div>
			...
			<section
				className={
					styles.form + ' container max-w-screen-md mx-auto mt-16 pr-6'
				}
				title="Main form"
			>
